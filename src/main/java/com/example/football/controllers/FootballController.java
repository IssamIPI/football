...
public class FootballController {
    ...
    public void init() {
        ...
        User Kevin = new User("Kevin", "Vong", "kevinvong", "kevkev", "kevinvong", "kevin.vong@gmail.com");
        User Issam = new User("Issam", "Allouani", "issamall", "ississ", "issamall", "issam.allouani@gmail.com");
       if(userRepository.findUserByLogin(Kevin.getLogin()) == null) userRepository.save(Kevin);

        if(userRepository.findUserByLogin(Issam.getLogin()) == null) userRepository.save(Issam);
        ...
        league1.setStartDate(LocalDate.of(2022, 9, 1));
        league1.setEndDate(LocalDate.of(2023, 6, 30));
        ...
        league2.setStartDate(LocalDate.of(2023, 9, 1));
        league2.setEndDate(LocalDate.of(2024, 6, 30));
